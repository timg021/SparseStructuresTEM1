...
int main(void)
{
	...
	try
	{
		for (size_t i = 0; i < nangles; i++)
		{
			...
			autoslictxt[0] = "1.Name_of_file_with_input_atomic_coordinates_in_x, y, z_format: si3n4.xyz";
			autoslictxt[1] = "2.Replicate_unit_cell_by_NCELLX, NCELLY, NCELLZ : 1 1 1";
			autoslictxt[2] = "3.Name_of_file_to_get_binary_output_of_multislice_result : si3n4_45.tif";
			...
			autoslictxt[24] = "25.Sample_(xz)_rotation_angle_in_radians : 0.785398163397";
