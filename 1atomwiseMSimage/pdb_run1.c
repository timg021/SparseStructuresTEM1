...
int xyz_Kirck_write1(int iii, pdbdata* ppd, char* outfile, char* cfileinfo, double ctblength, double xminx0, double yminy0, double zminz0)
{
	int i, ia, j;
	...
	for (i = 0; i < ppd->natoms; i++)
	{
		if (i != iii) continue; // only read output for the single selected atom
